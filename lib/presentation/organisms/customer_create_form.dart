...
import '../../modules/third-party/domain/models/thirdparties.common.dart';
...
class _CustomerCreateFormState extends State<CustomerCreateForm> {
  ...
  void _applyDefaults(CommonStore common) {
    if (_defaultsApplied || !common.loaded) return;
    _documentTypeId ??=
        common.documentTypes.isNotEmpty ? common.documentTypes.first.id : null;
    _personTypeCode ??=
        common.personTypes.isNotEmpty ? common.personTypes.first.code : null;
    _vatRegimeCode ??=
        common.regimesIva.isNotEmpty ? common.regimesIva.first.code : null;
    _fiscalRespCode ??= common.fiscalResponsibilities.isNotEmpty
        ? common.fiscalResponsibilities.first.code
        : null;
  ...
  Future<void> _submit() async {
    ...
    if (_documentTypeId == null ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Completa los selects del formulario')),
      );
      return;
    }
                ...
                children: [
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'Teléfono 1'),
                      validator: (v) => (v == null || v.trim().isEmpty)
                          ? 'Requerido'
                          : null,
                    ),
          ...
          _FormSection(
            ...
            children: [
              DropdownButtonFormField<String>(
                ...
                isExpanded: true,
                decoration: const InputDecoration(labelText: 'Régimen IVA'),
